...
<div class="body-container">
    <div class="banner-container">
        <img class="banner" src="images/banner_katalog.png">
        ...
        "; ?> 
            <div class="product-container">
                <div class="sepatu-container">
                    ...
                    if ($katalog["diskon"] !=0){?>
                        <div class="label">
                            ...
                            <a href="productpage.php?idproduk=<?php echo $katalog['id_produk'] ?>"><img class="sepatu" src=<?= $katalog["g1"]; ?> > </a>
                        </div>
                    <?php } else { ?>
                        <br><br><br>
                        <a href="productpage.php?idproduk=<?php echo $katalog['id_produk'] ?>"><img class="sepatu" src=<?= $katalog["g1"]; ?> > </a>
                ...
                <div class="product-desc">
                    ...
                    <?php
                    if ($katalog["diskon"] !=0){?>
                        <span class="product-newprice">Rp <?= number_format($katalog["harga_baru"],0," ","."); ?></span>
                        <span class="product-orgprice">Rp <?= number_format($katalog["harga"],0," ","."); ?></span>
                    <?php } else {?>
